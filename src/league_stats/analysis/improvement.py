...
def support_utility_impact(
    ...
    """Composite utility output: CC, damage share, healing/min, shielding/min."""
    ...
    if hpm is not None and hpm_bench > 0:
    ...
    if spm is not None and spm_bench > 0:
